...
function! echodoc_provider#get() abort
  return s:default
endfunction

function! echodoc_provider#get_cache(filetype) abort
  if !has_key(s:complete_cache, a:filetype)
    let s:complete_cache[a:filetype] = {}
  endif
...
function! echodoc_provider#make_cache(filetype, item) abort
  let cache = echodoc_provider#default#get_cache(a:filetype)
